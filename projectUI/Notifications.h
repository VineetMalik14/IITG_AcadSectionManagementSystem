...
/// <summary>
/// Summary for admin_notification
/// </summary>
public ref class admin_notification : public System::Windows::Forms::Form
{
public:
admin_notification(void)
{
InitializeComponent();
//
...
this->Text = L"admin_notification";
...
namespace projectUI {
	...
	public: 
		...
		StudentNoticifications(String ^ temp)
		{
			InitializeComponent();
			//
			//TODO: Add the constructor code here
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(823, 484);
	...
	private: System::Void StudentNoticifications_Load(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 void generateNotcfButtons(){
				 ...
				 { 
					 ...
					 String ^ aString = "Select * from Notification where [OtherReceivers] ='"+usrnm+"'AND [Session]='"+session+"' AND [Semester]='"+semesterName+"'" ;
